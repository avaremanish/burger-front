  ...
  return (
    <div className="App">
          ...
          <div className="modal">
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-buttons">
                ...
                <button onClick={() => setModal(false)} className="place-order">
                  Cancel
                </button>
              </div>
            </form>
      ...
      <div className="burger-items">
        ...
        {/* <div className="burger-item">
          <button className="item-buttons" onClick={() => handleInc("Paneer")}>
            +
          </button>
          <div>Paneer</div>
          <button className="item-buttons" onClick={() => handleDec("Paneer")}>
            -
          </button>
        </div> */}
        <div className="burger-item">
          <button className="item-buttons" onClick={() => handleInc("Cheese")}>
            +
          </button>
          <div>Cheese</div>
          <button className="item-buttons" onClick={() => handleDec("Cheese")}>
            -
          </button>
        </div>
        <div className="burger-item">
